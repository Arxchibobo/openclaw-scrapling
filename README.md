...
![OpenClaw Skill](https://img.shields.io/badge/OpenClaw-Skill-blue) ![License](https://img.shields.io/badge/license-Complete terms in LICENSE.txt-green)
...
```bash
openclaw skill install github:Arxchibobo/openclaw-scrapling
```
...
git clone https://github.com/Arxchibobo/openclaw-scrapling.git scrapling-official
```
